export default function Hero() {
  return (
    <div className="default-margin flex h-screen flex-col items-center justify-center bg-topo-texture-mobile bg-cover shadow-[inset_0_0_150px_10px_#000000] sm:bg-topo-texture-desktop">
      <h1 className="font-title mt-auto text-center text-xl font-bold md:text-5xl lg:text-5xl">
        Oi, meu nome é{' '}
        <span className="text-highlight">Francisco Cãndido,</span> um
        desenvolvedor frontend do Brasil
      </h1>
